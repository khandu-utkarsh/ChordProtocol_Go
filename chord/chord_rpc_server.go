...
func (s *Server) FindSuccessor(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("FindSuccessor : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) FindPredecessor(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("FindPredecessor : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) Notify(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("Notify : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) IsAlive(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("IsAlive : Receive message body from client : %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) AddKeyValueToStore(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("AddKeyValueToStore : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) IsKeyPresentInStore(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("IsKeyPresentInStore : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
...
func (s *Server) GetValueOfKeyInStore(ctx context.Context, in *NodeMessage) (*NodeMessage, error) {
	log.Printf("GetValueOfKeyInStore : Receive message body from client: %s %s %s %s %s", in.Id, in.IpAddress, in.Port, in.Path, in.Log)
